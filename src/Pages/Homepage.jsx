...
const Homepage = () => {
  ...
  const fetchNearbyParkings = useCallback(async (lat, lng) => {
    ...
    try {
      // Make sure both lat and lng are being passed in the params
      console.log("Fetching with coords:", { lat, lng }); // Add this to debug
      const response = await axios.get(
        `http://localhost:3001/parkings/api/parkings/nearby`,
        {
          params: {
            lat,
            lng, // Make sure lng is included and has a value
            limit: 10,
          },
        }
      );
      ...
      setParkingError("Failed to load nearby parkings");
    } finally {
  ...
  // Modify your handleSearch function to include the selected parking if available
  const handleSearch = () => {
    if (!validateForm()) return;

    // Get the selected parking if any
    const selectedParking = nearbyParkings[currentParkingIndex];
  ...
  return (
    <Fragment>
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex flex-wrap md:flex-nowrap gap-4">
                    ...
                    <div className="relative w-full md:w-[50%]">
                      ...
                      >
                        <div className="text-Mwhite text__14">
                        ...
                        >
                          {vehicleTypes.map((type, index) => (
                            ...
                            >
                              ...
                              <div className="text-[#A3A3A3] text__12">
                                {type.description}
                              </div>
                            </li>
                          ))}
                  ...
                  <div className="flex flex-wrap md:flex-nowrap gap-4">
                    <div className="w-full md:w-1/2">
                      <label className="text-Mwhite text__14 block mb-1">
                        Beginning
                      </label>
                      <div className="flex w-full gap-2">
                        <div
                          className={`flex items-center gap-2 bg-[#ffffff1a] px-3 rounded-[16px] flex-grow transition-all hover:bg-[#ffffff26]`}
                        >
                        ...
                        <div
                          className={`flex items-center gap-2 bg-[#ffffff1a] px-3 rounded-[16px] w-[120px] transition-all hover:bg-[#ffffff26]`}
                        >
      ...
      {/* Replace the existing "Find parking near your destination" section with this: */}
