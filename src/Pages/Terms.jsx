            ...
            <section className='pb-0'>
                <Container>
                    <div className="text-center">
                        <h2 className='font-bold text__48 mb-2'>Term & Conditioner</h2>
                ...
                <Container>
                    <Row className='justify-center'>
                        <Col md={10}>
                            ...
                            <div className="mb-3">
                                <h5 className='font-bold text__18 mb-2'>Services</h5>
                            ...
                            <div className="mb-3">
                                <h5 className='font-bold text__18 mb-2'>Accounts</h5>
                            ...
                            <div className="mb-3">
                                <h5 className='font-bold text__18 mb-2'>Intellectual Property</h5>
                            ...
                            <div className="mb-3">
                                <h5 className='font-bold text__18 mb-2'>Links To Other Web Sites</h5>
                            ...
                            <div className="mb-3">
                                <h5 className='font-bold text__18 mb-2'>Changes</h5>
