...
const ParkingListOwner = () => {
  ...
  const fetchMyParkings = async () => {
    try {
      ...
      setError(
        err.response?.data?.message || "Erreur lors du chargement des parkings"
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="px-6 pt-6 pb-6">
            ...
            <div className="mt-4 bg-gray-50 p-4 rounded-lg shadow-sm">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-white rounded-lg shadow-sm border border-gray-100 transition-all hover:shadow-md">
                  ...
                  <p
                    className="text-lg font-semibold flex items-center mt-1"
                    style={{ color: "#2563eb" }}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mt-4">
              ...
              <p className="text-gray-600 mt-1 bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                {parking.description ||
                  "Emplacement de stationnement sécurisé avec accès 24h/24 et surveillance vidéo."}
              </p>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2 mt-1">
                <span
                  className="px-2 py-1 rounded-md text-xs flex items-center transition-transform hover:scale-105"
